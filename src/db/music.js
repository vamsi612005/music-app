let musicDB = [
    {
        download: "https://drive.google.com/uc?export=download&id=1oEFhoYWFvEXNIYn0o8kNDxVCb0LBFCXR",
        id: 0,
        name: "Shakedown",
        author_name: "Clarx",
        img: "shakedown.jpg",
    ...
    {
      id: 9,
      name: "Nee Singham Dhan",
      author_name: "A R Rahman",
      img: "pathu-thala-tamil-2023.jpg",
      lang: "TAMIL",
      timesPlayed: 0,
      type: "electronic",
      musicName: "Nee-Singam-Dhan-MassTamilan.dev.mp3",
      attribution: {
          song: "Pathu Thala",
          musicBy: "A R Rahman",
          download: "https://tinyurl.com/3xwyfk4s",
          stream: "https://www.youtube.com/watch?v=kw6SFbbinnY"
          }
      },
      {
        id: 10,
        ...
        timesPlayed: 0,
        type: "electronic",
        musicName: "Naa-Ready-MassTamilan.dev.mp3",
        attribution: {
            song: "Naa Ready",
            musicBy: "Anirudh",
            download: "https://tinyurl.com/4kvpfnwf",
            stream: "https://www.youtube.com/watch?v=szvt1vD0Uug"
            }
        },
      {
        id: 11,
        ...
        timesPlayed: 0,
        type: "electronic",
        musicName: "The-Weeknd-Blinding-Lights-(HiphopMood.com)(1).mp3",
        attribution: {
            song: "Blinding Lights",
            musicBy: "Weeknd",
            download: "https://tinyurl.com/26t4m9ph",
            stream: "https://www.youtube.com/watch?v=4NRXx6U8ABQ"
            }
        },
        {
          id: 12,
          name: "People of kotha",
          author_name: "Benny",
          img: "3.jpg",
          lang: "MALAYALAM",
          timesPlayed: 0,
          type: "instrumental",
          musicName: "People Of Kotha.mp3",
          attribution: {
              song: "People of kotha",
              musicBy: "Jakes Bejoy and Travis King.",
              download: "https://tinyurl.com/t2c9ryn8",
              stream: "http://youtu.be/zbqgv0mMfwk"
          }
      },
      
      {
          ...
          timesPlayed: 0,
          type: "electronic",
          musicName: "Animals.mp3",
          attribution: {
              song: "Animals",
              musicBy: "Maroon 5",
              download: "https://tinyurl.com/mswhpzs3",
              stream: "http://youtu.be/qJT0mc3q6Lg"
          }
      },
      {
          ...
          timesPlayed: 0,
          type:"instrumental",
          musicName: "Bilionera.mp3",
          attribution: {
              song: "bilionera",
              musicBy: "Otilia",
              download: "https://tinyurl.com/mrkdfcv6",
              stream: "https://www.youtube.com/watch?v=a5xy6-jhbmw"
          }
      },
      {
          id: 15,
          name: "Bloody-Sweet",
          author_name: " Aniruth",
          img: "bloody sweer.jpg",
          lang: "ENGLISH",
          type: "electronic",
          timesPlayed: 0,
          musicName: "Bloody-Sweet.mp3",
          attribution: {
              song: "Bloody-Sweet",
              musicBy: "Aniruth",
              download: "https://tinyurl.com/5cn86x2h",
              stream: null
          }
      },
      {
          ...
          timesPlayed: 0,
          type: "electronic",
          musicName: "Dandelions.mp3",
          attribution: {
              song: "Dandelions",
              musicBy: "Ruth-B",
              download: "https://tinyurl.com/yckw928f",
              stream: "http://youtu.be/Pww31vN_1QY"
          }
      },
      {
          ...
          name: "Mockingbird",
          author_name: "Eminem",
          img: "mocking bird.jpg.jpeg",
          lang: "ENGLISH",
          timesPlayed: 0,
          type: "electronic",
          musicName: "Mockingbird.mp3",
          attribution: {
              song: "Mockingbird",
              musicBy: "Eminem",
              download: "https://tinyurl.com/2p439pzc",
              stream: "http://youtu.be/Whw1sWDpAvE"
          }
      },
      {
          ...
          author_name: "Anirudh",
          img: "ordinary person.jpeg",
          lang: "ENGLISH",
          timesPlayed: 0,
          type: "electronic",
          musicName: "Ordinary-Person.mp3",
          attribution: {
              song: "Ordinary-Person",
              musicBy: "Anirudh",
              download: "https://tinyurl.com/yckayaxs",
              stream: "http://youtu.be/vJAcXd_UtWQ"
          }
      },
      {
          ...
          attribution: {
              song: "Snap",
              musicBy: "Rosa",
              download: "https://tinyurl.com/bdh7weex",
              stream: null
          }
      },
      {
        ...
        attribution: {
            song: "Heuse",
            musicBy: "Spiderman",
            download: "https://tinyurl.com/5b5wr4tn",
            stream: "http://youtu.be/zbqgv0mMfwk"
        }
      }
];
